...
interface Contributors: CoroutineScope {
    ...
    enum class LoadingStatus { INI, COMPLETED, CANCELED, IN_PROGRESS }

    data class LoadingStateData(
        val status: LoadingStatus = LoadingStatus.INI,
    ...
    private fun clearResults() {
        ...
        updateLoadingStatus(LoadingStateData(LoadingStatus.IN_PROGRESS))
    ...
    fun updateLoadingStatus(newStatus: Contributors.LoadingStateData)
